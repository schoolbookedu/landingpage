...
const about = () => {
  return (
    <div className='bg-[#FFFFFF] py-[50px] lg:py-[100px] px-[20px] lg:px-[150px]'>
      ...
      <p className='text-[#000] text-left lg:text-sm font-normal lg:leading-7 mt-5 '>
      ...
      <div>
        ...
        <p className='text-[#000] text-left lg:text-sm font-normal lg:leading-7 mt-5'>{`Our mission is to use technology to drive and enhance the teaching and learning experiences of academic instructors and students within tertiary institutions in Nigeria, while expanding the consumer and market reach of remote vendors within academic campus.`}</p>
        <h1 className='text-[#000] capitalize text-xl lg:text-3xl font-bold leading-snug lg:leading-snug mt-5'>
          Vision
        </h1>
        <p className='text-[#000] text-left lg:text-sm font-normal lg:leading-7 mt-5 '>{`To empower and provide every academic player with the necessary learning tools for schooling and learning across institutions of learning in Nigeria to measure up to global standards.`}</p>
      </div>
    </div>
  )
}
